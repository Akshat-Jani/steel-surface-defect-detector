...
# ---------------- LOAD MODELS ----------------
autoencoder = load_model("anomaly_detection/steel_autoencoder.keras")
classifier_model = load_model(r"D:\Python_Programs\Projects\Steel-surface-defect-detector\models\mobilenetv2_defect.keras")

from explainability.gradcam import gradcam_on_image
from anomaly_detection.infer_anomaly import anomaly_score_and_map
from classifiers.inference import predict_defect
